                ...
                <ul class="list-unstyled list-inline" id="mega-menu">
                    ...
                    <li class="dropdown mega-dropdown">
                        ...
                        <ul class="dropdown-menu mega-dropdown-menu row">
                            ...
                            $query = "SELECT * from category WHERE domestic=1 ORDER BY id DESC";
                            ...
                            <li class="col-sm-3">
                                <ul>
                                    <li class="dropdown-header"><a href="single-cat.php?id=<?php echo $catdata->id?>"><?php echo $catdata->name?></a></li>
                                    <?php
                                    $subcategories = "SELECT * FROM subcategory WHERE category_id='$catdata->id' LIMIT 3";
                                    $subcategories = $dbcon->prepare($subcategories);
                                    $subcategories->execute();
                                    while($subcategory_data = $subcategories->fetch(PDO::FETCH_OBJ)) :
                                    ?>
                                    <li><a class="subcategory" href="view-all.php?subcat=<?php echo $subcategory_data->id ?>"><?php echo $subcategory_data->name ?></a></li>
                                    <?php endwhile;?>
                                    <li class="dropdown-header"><a href="single-cat.php?id=<?php echo $catdata->id?>">See All</a></li>
                                </ul>
                            </li>
                            <?php endwhile;?>
                        </ul>
                    ...
                    <li class="dropdown mega-dropdown">
                        ...
                        <ul class="dropdown-menu mega-dropdown-menu row">
                            ...
                            $query = "SELECT * from category WHERE commercial=1 ORDER BY id DESC";
                            $query = $dbcon->prepare($query);
                            $query->execute();
                            while($catdata = $query->fetch(PDO::FETCH_OBJ)) :
                                ?>
                                <li class="col-sm-3">
                                    <ul>
                                        <li class="dropdown-header"><a href="single-cat.php?id=<?php echo $catdata->cat_id?>"><?php echo $catdata->name?></a></li>
                                        <?php
                                        $subcategories = "SELECT * FROM subcategory WHERE category_id='$catdata->id' LIMIT 3";
                                        $subcategories = $dbcon->prepare($subcategories);
                                        $subcategories->execute();
                    ...
                    <li class="dropdown mega-dropdown">
                        ...
                        <ul class="dropdown-menu mega-dropdown-menu row">
                            ...
                            $query = "SELECT * from category WHERE industrial=1 ORDER BY id DESC";
                            $query = $dbcon->prepare($query);
                            $query->execute();
                            while($catdata = $query->fetch(PDO::FETCH_OBJ)) :
                                ?>
