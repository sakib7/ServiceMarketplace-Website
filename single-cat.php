<?php
        ...
        require_once 'main-header-dhaka-setup.php';
          $query = "SELECT count(*) as total_cat FROM subcategory WHERE category_id = :category";
        ...
        $query = "SELECT * FROM subcategory WHERE category_id = :category ORDER BY `id` DESC LIMIT ".$start.", 4";
	...
	<!-- heading section -->
                    ...
                    <div class="col-sm-6">
                        <div class="breadcumb text-right">
                            <ol class="breadcrumb">
                                ...
                                <li><a href="single-cat.php?id=<?php echo $category->id?>"><?php echo $category->name?></a></li>
                            </ol>
                        </div>
                    </div>
                </div>
        ...
        <div class="service-section">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="heading"><?php echo $subcategory->name?></h3>
                        <?php
                        $servStatus="active";

                        $service_query = "SELECT id,name,image FROM service WHERE status=:servstatus AND subcategory_id=:subcategory ORDER BY created DESC LIMIT 8 ";
                        $service_query = $dbcon->prepare($service_query);
                        $service_query->bindValue(":subcategory",$subcategory->id);
                                    ...
                                    <div class="flipEffect">
                                        <div class="front-content">
                                            <div class="service-image">
                                                <img src="images/services/<?php echo $service->image?>" alt="image-1" class="img-responsive">
                                            </div>
                                        ...
                                        <div class="serv-btns">
                                            <a href="single.php?id=<?php echo $service->id?>" class="btn btn-default view-btn">view details</a>
                                            <a href="<?php echo $service->id?>" data-toggle="modal" data-target="#cartModal" class="btn btn-default add-cart">add to cart</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <a href="view-all.php?subcat=<?php echo $subcategory->id;?>" class="btn btn-default">view all</a>
                    </div>
                </div>
                <?php endwhile;?>
            </div>
