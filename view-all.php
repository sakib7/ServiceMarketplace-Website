<?php
        ...
        $query = "SELECT category.name as cat_name,
                category.id as cat_id,
                subcategory.name as subcat_name,
                subcategory.id as subcat_id,
                count(*) as total_service 
                  FROM subcategory inner join category on subcategory.category_id=category.id
        ...
        $subcat_query = "SELECT * FROM service WHERE status=:servstatus AND subcategory_id=:subcat";
