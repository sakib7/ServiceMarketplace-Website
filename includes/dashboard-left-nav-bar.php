                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li>
                                    <a><i class="fa fa-paper-plane-o"></i>Coupons <span class="fa fa-chevron-down"></span></a>

                                    <ul class="nav child_menu">
                                        <li><a href="add-coupon.php">Add New Coupons</a></li>
                                        <li><a href="viewad.php">View All Coupons</a></li>
                                    </ul>
                                </li>
                                <li>
