...
$ad = $dbcon->query($ad);
        ...
        $query = "SELECT * FROM category ORDER BY id DESC LIMIT ".$start.", 12";
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-3 col-xs-12">
                        <a href="single-cat.php?id=<?php echo $category->id?>">
                            <div class="category-image">
                                <img src="images/category/<?php echo $category->image?>" alt="image-1" class="img-responsive">
                            </div>
